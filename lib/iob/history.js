...
function calcTempTreatments (inputs, zeroTempDuration) {
    ...
    for (var i=0; i+1 < tempHistory.length; i++) {
		...
		//	console.error("TBR "+tempHistory[i].id+" wurde auf "+tempHistory[i].duration+" angepasst wg. TBR "+tempHistory[i+1].id+" ");
		// PG AAPS TBR-Cancel Records entfernen
